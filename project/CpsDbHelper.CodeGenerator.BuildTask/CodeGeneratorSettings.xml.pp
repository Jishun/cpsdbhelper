<DacpacExtractor xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema"
    ...
    <!--<PluralMappings EntityName="Tax"  PluralForm="Taxes"/>-->    <!--to map non 's' plural forms to get method name more pretty-->    <!--Allow Multiple-->
    ...
    <ObjectsToIgnore></ObjectsToIgnore><!--Allow Multiple-->
</DacpacExtractor>
