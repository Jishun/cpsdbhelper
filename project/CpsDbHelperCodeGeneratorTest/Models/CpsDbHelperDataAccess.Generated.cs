...
namespace CpsDbHelper
{
    public partial class CpsDbHelperDataAccess : ICpsDbHelperDataAccess
    {
        ...
        public IList<Table1> GetTable1sByName12(string name12)
        {
            const string query = "SELECT * FROM [dbo].[Table1] WHERE [Name12] = @name12";
            var ret = _db.BeginReader(query)
                         .AddNtextInParam("Name12", name12, true)
                         .AutoMapResult<Table1>() 
                         .ExecuteSqlString()
                         .GetResult<IList<Table1>>(); 
            return ret;
        ...
        public IList<Table1> GetTable1sByName19(byte[] name19)
        {
            const string query = "SELECT * FROM [dbo].[Table1] WHERE [Name19] = @name19";
            var ret = _db.BeginReader(query)
                         .AddTimestampInParam("Name19", name19, true)
                         .AutoMapResult<Table1>() 
                         .ExecuteSqlString()
                         .GetResult<IList<Table1>>(); 
            return ret;
        ...
        {
            const string query = "IF EXISTS(SELECT 1 FROM [dbo].[Table1] WHERE [Id] = @id) UPDATE [dbo].[Table1] SET [Id] = @id, [Name] = @name, [Name1] = @name1, [Name2] = @name2, [Name3] = @name3, [Name4] = @name4, [Name5] = @name5, [Name6] = @name6, [Name7] = @name7, [Name8] = @name8, [Name9] = @name9, [Name0] = @name0, [Name11] = @name11, [Name12] = @name12, [Name13] = @name13, [Name14] = @name14, [Name15] = @name15, [Name16] = @name16, [Name17] = @name17, [Name18] = @name18, [Name19] = @name19, [Name20] = @name20, [Name21] = @name21, [Name22] = @name22, [Name23] = @name23, [Name24] = @name24, [Name25] = @name25, [Name26] = @name26, [Name27] = @name27, [Name28] = @name28  WHERE [Id] = @id ELSE INSERT INTO [dbo].[Table1] ([Id], [Name], [Name1], [Name2], [Name3], [Name4], [Name5], [Name6], [Name7], [Name8], [Name9], [Name0], [Name11], [Name12], [Name13], [Name14], [Name15], [Name16], [Name17], [Name18], [Name19], [Name20], [Name21], [Name22], [Name23], [Name24], [Name25], [Name26], [Name27], [Name28]) VALUES(@id, @name, @name1, @name2, @name3, @name4, @name5, @name6, @name7, @name8, @name9, @name0, @name11, @name12, @name13, @name14, @name15, @name16, @name17, @name18, @name19, @name20, @name21, @name22, @name23, @name24, @name25, @name26, @name27, @name28)";
            var ret = _db.BeginNonQuery(query) 
                         ...
                         .AddTimestampInParam("Name19",  table1.Name19, true) 
